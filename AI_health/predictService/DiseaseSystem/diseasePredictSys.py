...
class DiseasePredictSys:
    ...
    def __init__(self):
        self.model_link =  os.path.join(module_dir, "pre_trained_model\\decisionTreeDisease.joblib") # tên model sẽ dùng
        self.engLabel_link = os.path.join(module_dir, "data\\engDisease.json") # File nhãn dữ liệu ví dụ {0: Bệnh A, 1: Bệnh B}
        self.viLabel_link = os.path.join(module_dir, "data\\viDisease.json") # File nhãn dữ liệu ví dụ {0: Bệnh A, 1: Bệnh B}
        self.engSymptoms_link = os.path.join(module_dir, "data\engSymptoms.json") # File triệu chứng tiếng anh
        self.viSymptoms_link = os.path.join(module_dir, "data\\viSymptoms.json") # File triệu chứng tiếng việt
    ...
    def debug(self):
        print(module_dir)
        print(os.path.join(module_dir, "data\engDisease.json"))
